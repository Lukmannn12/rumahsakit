        ...
        <div class="flex flex-col justify-center items-center gap-3">
            ...
            <div class="max-w-screen-lg grid grid-cols-1 xl:grid-cols-3 py-2 xl:py-8 gap-5">
                <div class="bg-[#F1F9FF] shadow-md p-6 space-y-5 border-t-4 border-[#095D7E]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-[#095D7E]" width="48" height="48" viewBox="0 0 24 24"><circle cx="12" cy="6" r="4" fill="currentColor"/><path fill="currentColor" d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5"/></svg>
                    </div>
                ...
                <div class="bg-[#F1F9FF] shadow-md p-6 space-y-5 border-t-4 border-[#095D7E]">
                    <div class="flex justify-start">
                    <svg xmlns="http://www.w3.org/2000/svg"  class=" text-[#095D7E]" width="48" height="48" viewBox="0 0 24 24"><path fill="currentColor" d="m5.825 21l1.625-7.025L2 9.25l7.2-.625L12 2l2.8 6.625l7.2.625l-5.45 4.725L18.175 21L12 17.275z"/></svg>
                    </div>
