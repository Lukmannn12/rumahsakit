        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->user()->role == 'admin' ? route('dashboard') : route('dokter.index') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('datadokter.index')" :active="request()->routeIs('datadokter.index')">
                        {{ __('Data Dokter') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('reservasi.datareservasi')" :active="request()->routeIs('reservasi.datareservasi')">
                        {{ __('Data Reservasi') }}
                    </x-nav-link>
                </div>
                @endif

                {{-- Menu yang bisa diakses oleh ADMIN dan DOKTER --}}
                @endauth
